...
/* ══════════════════════════════════════════════════════
   MOCK DATA
══════════════════════════════════════════════════════ */
function getMember(hasActivePackage: boolean) {
...
function UpdateSheet({ onClose, onSubmit, member }: UpdateSheetProps) {
...
export function MemberProfileScreen({
  ...
  const MEMBER = getMember(hasActivePackage);
  ...
  return (
    <div className="relative flex flex-col min-h-screen" style={{ background:'#F0F4F5' }}>
        ...
        <div className="px-4 pt-4 space-y-4">
          ...
          <div>
            ...
            >
              ...
              ].filter(row => !row.studentOnly || hasActivePackage).map((row, i, arr) => (
                <div
                  key={i}
      ...
      ════════════════════════════════════════ */}
      {sheet === 'update' && (
        <UpdateSheet onClose={() => setSheet('none')} onSubmit={handleUpdateSubmit} member={MEMBER} />
      )}
      {sheet === 'pin' && (
