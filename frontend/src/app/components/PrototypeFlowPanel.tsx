...
export type Screen =
  ...
  | 'member-court-booking' | 'member-court-booking-history' | 'member-membership-overview' | 'member-membership-registration' | 'member-membership-request-history' | 'member-equipment-rental' | 'member-equipment-rental-history'
  /* Admin / Coach operation screens */
  | 'owner-operations' | 'court-booking' | 'booking-conflicts' | 'court-management'
  | 'people-operations' | 'coach-operations-schedule' | 'coach-reconciliation' | 'coach-debts'
  | 'finance' | 'finance-overview' | 'finance-revenue' | 'finance-expense' | 'finance-cash-flow'
  | 'finance-debts' | 'finance-reconciliation' | 'staff-operations' | 'inventory-operations'
  | 'experience-operations' | 'system-alerts' | 'report-court-coach-operations'
  /* Documentation */
  | 'screen-flow-doc';
