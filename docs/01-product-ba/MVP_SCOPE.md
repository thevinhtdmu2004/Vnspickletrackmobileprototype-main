...
| Item | Reason |
|---|---|
| Real backend | Prototype stage |
| Real database | Mock data only |
| Payment gateway | Future implementation |
| Push notification | Future implementation |
| Multi-device sync | Future implementation |
| Real access security | UI prototype only |

## Freeze Statement

```text
Prototype Freeze v1 covers Admin / Coach / Member journeys and should not be expanded without change control.
```
