...
/* ═══════════════════════════════════════════════════════════════
   TYPES & CONFIG
═══════════════════════════════════════════════════════════════ */
type AttendStatus = 'present' | 'makeup' | 'absent' | 'leave';
...
const STATUS_ORDER: AttendStatus[] = ['present', 'makeup', 'absent', 'leave'];
...
const INITIAL_STUDENTS: Student[] = [
  ...
  { id: 5, name: 'Hoàng Văn E', initials: 'HE', remaining: 8, status: 'present' },
          ...
          <div className="flex gap-2 pb-4 overflow-x-auto no-scrollbar">
            ...
            <button
              ...
              <span className="w-5 h-5 rounded-full flex items-center justify-center"
                style={{
                  background: filter === null ? 'rgba(14,124,123,0.15)' : 'rgba(255,255,255,0.2)',
